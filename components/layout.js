    ...
    return (
        <div className="flex flex-col gap-3 h-screen p-3">
            ...
            <div className="flex flex-col md:flex-row gap-3 flex-1 h-screen">
                <div className="w-full md:w-1/4 shrink-0 overflow-clip flex flex-col relative">
                    ...
                    <div className="absolute left-0 bottom-0 right-0 p-3 z-10 flex items-center place-content-between bg-white rounded-3xl">
