                ...
                <div className="m-auto w-6 h-6 relative">
                    <div className="absolute">
                        <Menu as="div" className="inline-block text-left relative">
                            ...
                            <Menu.Button className="flex items-center justify-center w-6 h-6">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 12.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 18.75a.75.75 0 110-1.5.75.75 0 010 1.5z" />
                                </svg>
                            </Menu.Button>

                            <Menu.Items className="absolute p-3 right-0 mt-2 origin-top-right divide-y divide-gray-100 bg-white rounded-xl ring-1 ring-black ring-opacity-5 focus:outline-none z-40">
                                <Menu.Item>
